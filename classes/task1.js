...
//EBook instances
const eBook1 = new EBook("Harry Potter and the Philosopher's Stone", "J. K. Rowling", 1960, "PDF");
eBook1.printInfo();
// //use getter
...
const book3 = new Book("Kobzar", "T.Shevchenko", 1840);
const eBook2 = EBook.createEBook(book3, "TXT");
console.log(eBook2);